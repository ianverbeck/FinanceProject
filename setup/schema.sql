...
CREATE TABLE "CAL_EARNINGSCALENDAR_UPC" (
"date" TIMESTAMP,
  "symbol" TEXT,
  "eps" REAL,
  "epsEstimated" REAL,
...
CREATE TABLE "MI_NASDAQHISTLIST" (
"dateAdded" TEXT,
  "addedSecurity" TEXT,
  "removedTicker" TEXT,
  "removedSecurity" TEXT,
